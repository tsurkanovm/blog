...
class Version20170505140207 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE solutions (id INT NOT NULL, image_id INT DEFAULT NULL, name VARCHAR(40) NOT NULL, UNIQUE INDEX UNIQ_A90F77E3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projects (id INT NOT NULL, image_template_id INT DEFAULT NULL, image_logo_id INT DEFAULT NULL, created DATE NOT NULL, updated DATE NOT NULL, name VARCHAR(40) NOT NULL, description LONGTEXT DEFAULT NULL, challenge LONGTEXT DEFAULT NULL, weight SMALLINT NOT NULL, status TINYINT(1) NOT NULL, display_on_home_page TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5C93B3A4CA0C4436 (image_template_id), UNIQUE INDEX UNIQ_5C93B3A46C9F4396 (image_logo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
